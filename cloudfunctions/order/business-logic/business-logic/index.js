...
const wxpayV3 = require('./wxpay-v3'); // 微信支付 V3 API
...
module.exports = {
  ...
  // 微信支付 V3（推荐使用）
  wxpayV3: {
    createWechatPayment: wxpayV3.createWechatPayment,
    createJsapiOrder: wxpayV3.createJsapiOrder,
    generateMiniProgramPaymentParams: wxpayV3.generateMiniProgramPaymentParams,
    verifyPaymentCallbackSignature: wxpayV3.verifyPaymentCallbackSignature,
    decryptPaymentCallback: wxpayV3.decryptPaymentCallback,
    yuanToFen: wxpayV3.yuanToFen,
    fenToYuan: wxpayV3.fenToYuan,
    generateNonceStr: wxpayV3.generateNonceStr
  },
