...
const adminHandlers = {
  ...
  getConfigList: require('./handlers/admin/getConfigList'),
  ...
  getFeedbackDetail: require('./handlers/admin/getFeedbackDetail'),
  handleFeedback: require('./handlers/admin/handleFeedback'),
  deleteFeedback: require('./handlers/admin/deleteFeedback'),
  replyFeedback: require('./handlers/admin/replyFeedback'),
  manageNotificationConfig: require('./handlers/admin/manageNotificationConfig'),
