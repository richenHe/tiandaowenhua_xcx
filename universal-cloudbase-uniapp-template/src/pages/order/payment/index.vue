        ...
        >
          <view class="payment-method__content">
            <view class="payment-method__left">
              <view class="payment-method__icon">
                <!-- 微信支付官方图标（气泡+对勾，源自官方横版 logo SVG） -->
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 348 290" width="64rpx" height="50rpx">
                  <path fill="#1AAD19" d="M126.459 194.058c-1.57.791-3.336 1.25-5.214 1.25c-4.347 0-8.125-2.392-10.111-5.93l-.76-1.663L79.333 118.21a6.58 6.58 0 0 1-.553-2.442c0-3.2 2.594-5.794 5.795-5.794c1.3 0 2.5.431 3.466 1.15l37.351 26.593c2.728 1.785 5.989 2.833 9.495 2.833c2.091 0 4.086-.392 5.944-1.066L316.43 61.303C284.384 24.25 232.532 0 173.853 0C77.834 0 0 64.864 0 144.884c0 43.653 23.417 82.95 60.07 109.51c2.941 2.1 4.866 5.549 4.866 9.441c0 1.286-.275 2.463-.612 3.691c-2.927 10.92-7.611 28.408-7.831 29.226c-.365 1.371-.935 2.801-.935 4.236c0 3.2 2.593 5.794 5.799 5.794c1.255 0 2.284-.467 3.344-1.078l38.061-21.974c2.864-1.651 5.894-2.676 9.235-2.676c1.776 0 3.493.275 5.107.768c17.757 5.107 36.913 7.945 56.749 7.945c96.016 0 173.859-64.869 173.859-144.884c0-24.237-7.181-47.061-19.804-67.14L127.727 193.324z"/>
                </svg>
              </view>
